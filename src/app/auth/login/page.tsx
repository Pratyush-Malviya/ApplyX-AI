    ...
    <div className="min-h-screen w-full bg-slate-950 text-slate-100 flex flex-col justify-between selection:bg-indigo-500 selection:text-white">
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-4 sm:p-8 shadow-2xl shadow-indigo-950/40">
          ...
          <div className="hidden lg:flex lg:col-span-6 flex-col justify-between p-8 bg-gradient-to-br from-violet-950/40 via-indigo-950/30 to-slate-950/80 border border-indigo-500/10 rounded-2xl relative overflow-hidden h-full min-h-[480px]">
            {/* Ambient glows */}
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="space-y-3.5 pt-2">
                ...
                <div className="flex items-center gap-3 text-sm text-slate-200">
                  ...
                  <span>Automated 1-Click Form Autofill</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-slate-200">
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">
                    <CheckCircle2 className="h-4 w-4" />
                  </div>
                  <span>Supports Naukri, LinkedIn, Indeed & More</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative z-10 mt-8 p-4 rounded-xl bg-slate-900/80 border border-slate-800 flex items-center gap-3 text-xs text-slate-300">
              ...
              <div>
                ...
                <p className="text-slate-400">Your resume data is end-to-end encrypted and completely private.</p>
              </div>
            </div>
          </div>

          {/* Right Side: Auth Form */}
          <div className="lg:col-span-6 p-2 sm:p-4 space-y-6">
            ...
            <p className="text-center text-sm text-slate-400 pt-2">
              {t("auth.noAccount")}{" "}
              <Link href="/auth/signup" className="font-semibold text-violet-400 hover:text-violet-300 hover:underline">
                {t("auth.signUpLink")}
              </Link>
            </p>
          </div>
